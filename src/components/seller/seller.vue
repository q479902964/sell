  ...
  <div class="seller" ref="seller">
    <div class="seller-content">
      <div class="overview">
        ...
        <ul class="remark">
          ...
          <li class="block">
            <h2>商家配送</h2>
            <div class="content">
              <span class="stress">{{seller.delivePrice}}</span>元
            </div>
          </li>
          <li class="block">
            <h2>平均配送时间</h2>
            <div class="content">
              <span class="stress">40</span>分钟
            </div>
          </li>
        </ul>
      ...
      <div class="info">
        ...
        <ul>
          <li class="info-item" >手机号:{{seller.cellPhoneNumber}}</li>
          <li class="info-item" >地址:{{seller.location}}</li>
          <li class="info-item" >简介:{{seller.profile}}</li>
        </ul>
      </div>
    </div>
  </div>
...
<script>
  ...
  import {saveToLocal, loadFromLocal} from '../../comment/js/store';
  export default {
    props: {
      seller: {
        type: Object
